...
This year's [Texata](http://www.texata.com/) competition was analyzing the NYC Txai Trips [data](http://www.andresmh.com/nyctaxitrips/).
...
At the end of this post, you can find the questions I was interested in.
...
I wish I was more familiar with graphing Geospatial data. I had a 60mb csv file of latitudes and longitudes of taxi pickup locations and wanted to see how/if it changed over time.
